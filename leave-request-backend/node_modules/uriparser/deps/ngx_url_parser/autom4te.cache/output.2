...
@%:@ Generated by GNU Autoconf 2.71 for ngx_url_parser 1.2.2.
@%:@
...
$0: accelerator@support.dreamlab.pl about your system,
...
PACKAGE_NAME='ngx_url_parser'
PACKAGE_TARNAME='ngx_url_parser'
PACKAGE_VERSION='1.2.2'
PACKAGE_STRING='ngx_url_parser 1.2.2'
PACKAGE_BUGREPORT='accelerator@support.dreamlab.pl'
PACKAGE_URL=''
...
if test "$ac_init_help" = "long"; then
  ...
  cat <<_ACEOF
\`configure' configures ngx_url_parser 1.2.2 to adapt to many kinds of systems.
...
Fine tuning of the installation directories:
  ...
  --docdir=DIR            documentation root @<:@DATAROOTDIR/doc/ngx_url_parser@:>@
...
if test -n "$ac_init_help"; then
  case $ac_init_help in
     short | recursive ) echo "Configuration of ngx_url_parser 1.2.2:";;
   esac
  cat <<\_ACEOF
...
if $ac_init_version; then
  cat <<\_ACEOF
ngx_url_parser configure 1.2.2
...
It was created by ngx_url_parser $as_me 1.2.2, which was
...
ac_config_files="$ac_config_files Makefile libngx_url_parser.pc"
